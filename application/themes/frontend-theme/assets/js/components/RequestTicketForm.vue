<template>
	<v-card class="elevation-base" :loading="loading" :disabled="loading">
		<v-card-text>
				...
				<v-row>
					<v-col cols="12">
						<v-text-field persistent-hint
							:disabled="loading"
							label="Email"
							placeholder="youremail@kalla.co.id"
							v-model="row.email"
							:error-messages="errorMsg.email"
							hint="Enter an email that has been registered on the Macca system"
						></v-text-field>
					</v-col>
				</v-row>
				<v-row>
		  ...
		  <v-alert v-if="hcCategory2" color="primary" text :class="{'mt-4': !!errorMsg.categoryId}">
           DOWNLOAD FORM : <br><a href="uploader/master_file/FORM_PENGAJUAN_MAGANG.docx"><img src="https://img.icons8.com/?size=1x&id=13624&format=png"></img></a>
          </v-alert>

		  <v-alert v-if="hcCategory5" color="primary" text :class="{'mt-4': !!errorMsg.categoryId}">
           DOWNLOAD FORM : <br><a href="uploader/master_file/FORM_PERMINTAAN_VOUCHER_GRABFOOD.docx"><img src="https://img.icons8.com/?size=1x&id=13624&format=png"></img></a>
          </v-alert>
		  ...
		  <v-alert v-if="hcCategory3" color="primary" text :class="{'mt-4': !!errorMsg.categorySubId}">
           DOWNLOAD FORM : <br><a href="uploader/master_file/FORM_MAINTENANCE.xlsx"><img src="https://img.icons8.com/?size=1x&id=8Q0JnVzEzZWf&format=png"></img></a>
          </v-alert>

		  <v-alert v-if="hcCategory4" color="primary" text :class="{'mt-4': !!errorMsg.categorySubId}">
           DOWNLOAD FORM : <br><a href="uploader/master_file/FORM_PERMINTAAN_CAPEX.xlsx"><img src="https://img.icons8.com/?size=1x&id=8Q0JnVzEzZWf&format=png"></img></a>
          </v-alert>

		  <v-alert v-if="hcCategory6" color="primary" text :class="{'mt-4': !!errorMsg.categorySubId}">
           DOWNLOAD FORM : <br><a href="uploader/master_file/Form_Pengajuan_Pemakaian_Car_Pooling.xlsx"><img src="https://img.icons8.com/?size=1x&id=8Q0JnVzEzZWf&format=png"></img></a>
          </v-alert>

		  <v-alert v-if="hcCategory7" color="primary" text :class="{'mt-4': !!errorMsg.categorySubId}">
           DOWNLOAD FORM : <br><a href="uploader/master_file/FORM_PERMINTAAN_VOUCHER_Transportasi.docx"><img src="https://img.icons8.com/?size=1x&id=13624&format=png"></img></a>
          </v-alert>

		  <v-alert v-if="hcCategory8" color="primary" text :class="{'mt-4': !!errorMsg.categorySubId}">
           DOWNLOAD FORM : <br><a href="uploader/master_file/Form_Pengajuan_Pemakaian_Car_Pooling.xlsx"><img src="https://img.icons8.com/?size=1x&id=8Q0JnVzEzZWf&format=png"></img></a>
          </v-alert>

		  <v-alert v-if="hcCategory9" color="primary" text :class="{'mt-4': !!errorMsg.categorySubId}">
           DOWNLOAD FORM : <br><a href="uploader/master_file/Form_Pengajuan_COP.docx"><img src="https://img.icons8.com/?size=1x&id=13624&format=png"></img></a>
          </v-alert>

		  <v-alert v-if="hcCategory10" color="primary" text :class="{'mt-4': !!errorMsg.categorySubId}">
           DOWNLOAD FORM : <br><a href="uploader/master_file/FORM_PENGIRIMAN_DOKUMEN.docx"><img src="https://img.icons8.com/?size=1x&id=13624&format=png"></img></a>
          </v-alert>

		  <v-alert v-if="hcCategory11" color="primary" text :class="{'mt-4': !!errorMsg.categorySubId}">
           DOWNLOAD FORM : <br><a href="uploader/master_file/FORM_PERMINTAAN_PAPAN_UCAPAN_ATAU_PAKET_ISOMAN.docx"><img src="https://img.icons8.com/?size=1x&id=13624&format=png"></img></a>
          </v-alert>
...
export default {
  ...
  computed: {
	...
	hcCategory() {
      const find = _.find(this.categoryOptions, {value: this.row.categoryId})
      if (find) {
		if (find.text.includes("RECRUITMENT NEW EMPLOYEE")) {
        return find.text;}
      }
    },
	...
	hcCategory2() {
      const find = _.find(this.categoryOptions, {value: this.row.categoryId})
      if (find) {
		if (find.text.includes("RECRUITMENT INTERNSHIP")) {
        return find.text;}
      }
    },
	...
	hcCategory3() {
      ...
      if (find) {
		if (find.text.includes("Maintenance")) {
        return find.text;}
      }
    },
	...
	hcCategory4() {
      const find = _.find(this.categorySubOptions, {value: this.row.categorySubId})
      if (find) {
		if (find.text.includes("Pengadaan Capex")) {
        return find.text;}
      }
    },
	...
	hcCategory5() {
      const find = _.find(this.categoryOptions, {value: this.row.categoryId})
      if (find) {
		if (find.text.includes("Permintaan Voucher Grabfood")) {
        return find.text;}
      }
    },
	...
	hcCategory6() {
      const find = _.find(this.categorySubOptions, {value: this.row.categorySubId})
      if (find) {
		if (find.text.includes("Car Pooling")) {
        return find.text;}
      }
    },
	...
	hcCategory7() {
      const find = _.find(this.categorySubOptions, {value: this.row.categorySubId})
      if (find) {
		if (find.text.includes("Voucher Grab/Gojek")) {
        return find.text;}
      }
    },
	...
	hcCategory8() {
      const find = _.find(this.categorySubOptions, {value: this.row.categorySubId})
      if (find) {
		if (find.text.includes("Peminjaman Kendaraan")) {
        return find.text;}
      }
    },
	...
	hcCategory9() {
      const find = _.find(this.categorySubOptions, {value: this.row.categorySubId})
      if (find) {
		if (find.text.includes("Pengajuan COP") || find.text.includes("Pengajuan Sewa Murni")) {
        return find.text;}
      }
    },
	...
	hcCategory10() {
      const find = _.find(this.categorySubOptions, {value: this.row.categorySubId})
      if (find) {
		if (find.text.includes("Kirim Barang") || find.text.includes("Kirim Dokumen")) {
        return find.text;}
      }
    },
	...
	hcCategory11() {
      const find = _.find(this.categorySubOptions, {value: this.row.categorySubId})
      if (find) {
		if (find.text.includes("Ucapan - Papan Ucapan Duka") || find.text.includes("Ucapan - Papan Ucapan Bahagia") || find.text.includes("Ucapan - Papan Ucapan Selamat") || find.text.includes("Ucapan - Parcel Buah")) {
        return find.text;}
      }
    },
	...
	hcCategory12() {
      const find = _.find(this.categorySubOptions, {value: this.row.categorySubId})
      if (find) {
		if (find.text.includes("Off Boarding") || find.text.includes("On Boarding")) {
        return find.text;}
      }
    },
	...
	methods: {
		...
		fetchSBU() {
			this.sbuOptions  = [];
			this.$axios.get('request-ticket/sbu')
				.then(response => {
				const {data} = response;
				if (!data.success) {
					this.$coresnackbars.error(data.message);
				} else {
					this.sbuOptions = data.rows;
				}
			}).catch((error) => {
					console.log(error);
		...
		fetchServicesSub() {
			...
			this.$axios.get('request-ticket/services')
				.then(response => {
				const {data} = response;
				if (!data.success) {
					this.$coresnackbars.error(data.message);
		...
		/*fetchEmail() {
			this.row.categorySubId = '';
			this.categorySubOptions = [];
			this.$axios.get('request-ticket/email', {
				params: {parent_id: this.row.email}
			})
			.then(response => {
				const {data} = response;
				if (!data.success) {
