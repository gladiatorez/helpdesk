<template>
  <v-btn v-bind="$attrs" :icon="hideText" class="telegram-btn">
    <span class="svg-icon" :class="{'v-icon--left': !hideText}">
      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
           class="iconify iconify--logos" width="1em" height="1em" preserveAspectRatio="xMidYMid meet"
           viewBox="0 0 256 256"><path stroke-width="2" stroke="#ffffff"
          d="M128 0C57.307 0 0 57.307 0 128s57.307 128 128 128s128-57.307 128-128S198.693 0 128 0z"
          fill="#40B3E0"></path><path
          ...
          fill="#D2E5F1"></path><path d="M122.901 168.115l-20.867 19.026s-1.632 1.238-3.416.462l3.996-35.34"
                                      fill="#B5CFE4"></path></svg>
    </span>
    <span v-if="!hideText" class="white--text text-none" style="letter-spacing: normal">Telegram</span>
  </v-btn>
</template>
