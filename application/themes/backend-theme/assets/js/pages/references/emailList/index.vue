        ...
        <v-card flat>
            <v-card-title>
                <v-btn
                    ...
                    color="primary"
                    class="white--text"
                    :to="{ name: 'references.email_list.create' }">
...
export default {
    name: "references-email-list-page",
    data() {
        return {
            headers: [
                {
                ...
                {
                    text: this.$t("references::email_list:email"),
                    value: "email"
                },
                {
    ...
    methods: {
        ...
        removeAction(item) {
            ...
            if (confirm(confirmText)) {
                ...
                const that = this;
                this.$axios
                    .get("references/email_list/remove/", {
                        params: { id: item.id }
                    })
                    .then(response => {
                        const { data } = response;
