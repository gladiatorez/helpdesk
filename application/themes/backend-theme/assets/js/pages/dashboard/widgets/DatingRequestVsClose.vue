                    ...
                    <v-card outlined flat>
                        <v-simple-table dense>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 12px;" class="text-right">{{ leadTimeTarget }}%</td>
                            </tr>
                            <tr>
                                ...
                                <td
                                    ...
                                    class="text-right"
                                    :class="{'error white--text': leadTimeActual < leadTimeTarget, 'green accent-4': leadTimeActual >= leadTimeTarget}">
                                    {{ leadTimeActual }}%
                                </td>
                            </tr>
                            </tbody>
    ...
    data() {
        return {
            defaultOptions: {
                ...
                colors: ['#1E88E5'],
                title: {
                    text: 'Tiket Open vs Tiket Close (Service Rate)',
                },
                xAxis: {
                    categories: ['Tiket Open', 'Tiket Close']
                },
                yAxis: {
                    title: {
                        text: 'Jumlah'
