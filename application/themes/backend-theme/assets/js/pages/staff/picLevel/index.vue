        ...
        <v-card flat>
            <v-card-title>
                <v-btn
                    ...
                    color="primary"
                    :to="{ name: 'staff.pic_level.create' }">
...
export default {
    ...
    data() {
        return {
            headers: [
                ...
                {
                    text: this.$t("staff::pic_level:name"),
                    value: "name"
                },
                {
                    text: this.$t("staff::pic_level:level"),
                    value: "level",
                    width: "120px"
                },
                {
    ...
    methods: {
        ...
        refreshAction() {
            this.loading = true;
            fetchDtRows("staff/pic_level", this.tableOptions, this.searchText)
                .then(data => {
