...
/**
 * Class Backend_addons_api
 *
 */
class Backend_addons_api extends Backend_Api_Controller
{
    public $_themeName = '';
    ...
    public function companyoptions()
    {
        ...
        $this->template->build_json($companyOptions ? $companyOptions : []);
    }

    public function companyoptions2()
    {
        // get companies
        $this->load->model('references/company_model');
        $companies = $this->company_model->fields('id, name')
