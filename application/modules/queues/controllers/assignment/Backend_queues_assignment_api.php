...
/**
 * Class Backend_queues_assignment_api
 *
 ...
 */
class Backend_queues_assignment_api extends Backend_Api_Controller
{
    public $_section = 'assignment';
    ...
    public function change_flag()
    {
        ...
        //     userHasRoleOrDie('close_ticket', 'queues/assignment');
        // }
        $this->load->library('form_validation');
        $this->form_validation->CI = &$this;
