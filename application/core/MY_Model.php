...
class MY_Model extends CI_Model
{
    ...
    {
    	$data['created_by'] = $this->the_auth_backend->getUserLoginId();
    	return $data;
    }

    public function add_updater($data)
    {
	    $data['updated_by'] = $this->the_auth_backend->getUserLoginId();
	    return $data;
    }

    public function add_deleted($data)
    {
        $data['deleted_by'] = $this->the_auth_backend->getUserLoginId();
        return $data;
    }
